...
namespace org_mockito_android_internal_creation_inline {
...
Java_org_mockito_android_internal_creation_inline_ClassTransformer_nativeRedefine(JNIEnv* env,
                                                                   jobject generator,
                                                                   jstring idStr,
    ...
    ir::Type* dispatcherT = b.GetType("Lorg/mockito/android/internal/creation/inline/MockMethodDispatcher;");
...
Java_org_mockito_android_internal_creation_inline_JvmtiAgent_nativeRegisterTransformerHook(JNIEnv* env,
                                                                            jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_mockito_android_internal_creation_inline_JvmtiAgent_nativeUnregisterTransformerHook(JNIEnv* env,
                                                                              jobject thiz) {
...
extern "C" JNIEXPORT void JNICALL
Java_org_mockito_android_internal_creation_inline_JvmtiAgent_nativeRetransformClasses(JNIEnv* env,
                                                                       jobject thiz,
...
extern "C" JNIEXPORT void JNICALL
Java_org_mockito_android_internal_creation_inline_JvmtiAgent_nativeAppendToBootstrapClassLoaderSearch(JNIEnv* env,
                                                                                  jclass klass,
                                                                                  jstring jarFile) {
